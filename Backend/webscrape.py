...
# helper method that scrapes inner content of div to extract relevant plant data
...
for link in all_links:
    ...
    # go through each link and scrape all plant data necessary for that region
    # write that data to plants.csv
